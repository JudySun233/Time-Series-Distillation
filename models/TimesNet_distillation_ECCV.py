...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if self.task_name == 'long_term_forecast' or self.task_name == 'short_term_forecast':
            # TODO: distinguish last and other linear layers
            self.linear_layers = nn.ModuleList([nn.Linear(configs.d_model, configs.c_out) for _ in range(self.layer - 1)])
            self.last_layer = nn.Linear(configs.d_model, configs.c_out)
